  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{ transform }}
          className="absolute left-1/2 top-1/2 flex justify-start items-start rounded-2xl shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-white dark:bg-black border border-gray-300 dark:border-white/[0.1] group-hover/pin:border-gray-400 dark:group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden"
        >
